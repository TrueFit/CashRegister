...
public class CurrencyValueAddTests {
    @Test
    public void add_currencyValue_test() {
    ...
    public void add_currencyValue_AddCurrencyValueNullAddendException_test() {
        USD_NICKEL_VALUE.add(null);
    }

    @Test(expected = CurrencyValue.AddCurrencyValueDifferentCurrencyException.class)
    public void add_currencyValue_AddCurrencyValueDifferentCurrencyException_test() {

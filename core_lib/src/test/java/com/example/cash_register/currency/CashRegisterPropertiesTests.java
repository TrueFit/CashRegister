...
public class CashRegisterPropertiesTests {
    ...
    public void setInputLocaleLanguageTag_InputLocaleSetLanguageTagException_test() {
    ...
    public void setOutputLocaleLanguageTag_OutputLocaleSetLanguageTagException_test() {
        final String badLanguageTag = this.getBadLanguageTag();
    ...
    @Test
    public void setCurrencyCode_test() {
    ...
    @Test
    public void setInputLocaleLanguageTag_test() {
    ...
    @Test
    public void setOutputLocaleLanguageTag_test() {
        final String tag1 = "en-US";
        final String tag2 = "he-IL-u-ca-hebrew-tz-jeruslm";
        final Locale expected1 = Locale.forLanguageTag(tag1);
        final Locale expected2 = Locale.forLanguageTag(tag2);

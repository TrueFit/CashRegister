...
public class PhysicalCurrencyConvertMostTests {
    @Autowired
    ...
    public void convertToPhysicalCurrency_test() {
        ...
        for (int i = 0; i < 1_000; i++) {
            ...
            MatcherAssert.assertThat(physicalCurrencyBag, hasSize(171));
            MatcherAssert.assertThat(sum.getUnitValue(), equalTo(UnitValue.valueOf(171)));
        }
    }
}

...
public class CurrencyValueIsDivisibleByTests {
    ...
    public void isDivisibleBy_currencyValue_IsDivisibleByCurrencyValueNullDivisorException_test() {
    ...
    public void isDivisibleBy_currencyValue_IsDivisibleByCurrencyValueDifferentCurrencyException_test() {
    ...
    public void isDivisibleBy_physicalCurrency_IsDivisibleByPhysicalCurrencyNullDivisorException_test() {
    ...
    public void isDivisibleBy_physicalCurrency_IsDivisibleByPhysicalCurrencyDifferentCurrencyException_test() {

...
public class CurrencyValueSubtractTests {
    ...
    public void subtract_currencyValue_SubtractCurrencyValueNullSubtrahendException_test() {
    ...
    public void subtract_currencyValue_SubtractCurrencyValueDifferentCurrencyException_test() {
    ...
    public void subtract_physicalCurrency_SubtractPhysicalCurrencyNullSubtrahendException_test() {
    ...
    public void subtract_physicalCurrency_SubtractPhysicalCurrencyDifferentCurrencyException_test() {

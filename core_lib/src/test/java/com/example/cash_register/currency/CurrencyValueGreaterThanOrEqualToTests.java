...
public class CurrencyValueGreaterThanOrEqualToTests {
    @Test
    public void greaterThanOrEqualTo_currencyValue_test() {
    ...
    public void greaterThanOrEqualTo_currencyValue_GreaterThanOrEqualToCurrencyValueNullRightException_test() {
    ...
    public void greaterThanOrEqualTo_currencyValue_GreaterThanOrEqualToPhysicalCurrencyNullRightException_test() {

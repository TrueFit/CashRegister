...
public class CurrencyModelMapper extends ModelMapper {
     ...
     */
    public List<CalculateChangeResult.OutputModel> mapToOutputModel(Collection<CalculateChangeResult> item) {
     ...
     */
    public SortedSetMultimap<Currency, PhysicalCurrency> mapToSortedSetMultimap(PhysicalSetConfigParserResultCollection item) {
    ...
    private final static class ParserResultsCollectionToSortedSetMultimapOfCurrencyToPhysicalCurrencyConverter
         ...
         *
         * @return The {@link SortedSetMultimap}, which maps currency to a physical currency set.
         */
        @Override
         ...
         */
        private Map.Entry<Currency, Set<PhysicalCurrency>> toMapEntry(PhysicalSetConfigParserResult physicalSetConfigParserResult) {
            PhysicalSetConfig physicalSetConfig = physicalSetConfigParserResult.queryPhysicalSetConfig();
            Currency key = physicalSetConfig.getCurrency();
            Set<PhysicalCurrency> value = this.setOfPhysicalCurrencyConverter.convert(physicalSetConfig);

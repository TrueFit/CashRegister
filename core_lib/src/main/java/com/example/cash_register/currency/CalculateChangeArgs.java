...
public class CalculateChangeArgs {
    ...
    public static final class InputModelParser extends InputStreamParserBase {
         ...
         *
         * @throws ParseInputStreamObjectMapperReadValueException When the Jackson {@code .readValue} method fails.
         * @throws ParseInputModelException For any other failures.
         */
        @Override
        protected List<CalculateChangeArgs> parseImpl(final InputStream inputStream) {
            try (inputStream) {
                InputModel inputModel = this.jsonObjectMapper.readValue(inputStream, InputModel.class);
                return this.parse(inputModel);
            }
            catch (final IOException exception) {
                String message = "could not map value to InputModel";
                throw new ParseInputStreamObjectMapperReadValueException(message, exception);
            }
            catch (final Throwable throwable) {
                String message = "could not parse InputModel";
                throw new ParseInputModelException(message, throwable);
            }
        }
         ...
         */
        static final class ParseInputStreamObjectMapperReadValueException extends CashRegisterException {
            ParseInputStreamObjectMapperReadValueException(String message, Throwable cause) {
                super(message, cause);
            }
        }
         ...
         * @see #parseImpl(InputStream)
         */
        static final class ParseInputModelException extends CashRegisterException {
            ParseInputModelException(String message, Throwable cause) {
                super(message, cause);
            }
        }
    }
        ...
        void validate(final CalculateChangeArgs args) {
            ...
            if (args.getIsValidationComplete().compareAndSet(false, true)) {
                try {
                    ...
                    for (Throwable throwable : compoundException.getExceptionList()) {

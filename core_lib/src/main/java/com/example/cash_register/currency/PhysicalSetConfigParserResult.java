...
final class PhysicalSetConfigParserResult {
     ...
     */
    static PhysicalSetConfigParserResult fromJsonParseException(final Throwable jsonParseException) {
        final PhysicalSetConfigParserResult result = new PhysicalSetConfigParserResult();
     ...
     */
    static PhysicalSetConfigParserResult fromPhysicalSetConfig(final PhysicalSetConfig physicalSetConfig) {
        final PhysicalSetConfigParserResult result = new PhysicalSetConfigParserResult();
    ...
    /**
     * An {@link Optional} of {@link PhysicalSetConfig} wrapper for the physical set config property of this object.
     *
     * @return An {@link Optional} of {@link PhysicalSetConfig} which contains the physical set config of this object,
     * if present.
     */
    ...
    /**
     * An {@link Optional} of {@link Currency} wrapper for the currency property of this object.
     *
     * @return An {@link Optional} of {@link Currency} which contains the currency of this object, if present.
     */

...
public final class CurrencySumUtils {
     ...
     * @see CurrencyValue
     */
    public static CurrencyValue sumCurrencyValue(final Collection<CurrencyValue> currencyValueCollection) {
     ...
     * {@code currency}.
     */
    private static void checkSameCurrency(final Currency currency, final Collection<CurrencyValue> currencyValueCollection) {
        final Optional<Currency> currencyDoesNotMatch = currencyValueCollection
                .parallelStream()
     ...
     */
    public static CurrencyValue sumPhysicalCurrency(final Collection<PhysicalCurrency> physicalCurrencyCollection) {
        ...
        final List<CurrencyValue> currencyValues = physicalCurrencyCollection
                .parallelStream()
     ...
     */
    private static CurrencyValue add(final CurrencyValue left, final CurrencyValue right) {

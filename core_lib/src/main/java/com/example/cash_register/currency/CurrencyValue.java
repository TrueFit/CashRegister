...
/**
 * Represents an abstract currency value; it contains a unit value and currency.
 */
...
public final class CurrencyValue implements Comparable<CurrencyValue> {
     ...
     */
    static CurrencyValue getZero(Currency currency) {
     ...
     * @return A currency value with a unit value of zero and with the provided currency.
     */
    static CurrencyValue getOne(Currency currency) {
        return CurrencyValue.builder()
                .currency(currency)
                .unitValueAsLong(1)
                .build();
    ...
    /**
     * Creates a copy of a currency value.
     *
     * @param currencyValue The currency value to copy.
     *
     * @return A copy of the provided currency value.
     */
    static CurrencyValue copy(CurrencyValue currencyValue) {
        if (currencyValue == null) {
            return null;
        }
        final CurrencyValue copy = CurrencyValue.builder()
    ...
    public final static class CurrencyValueBuilder {
        ...
        /**
         * Helper to set the currency and unit value of this builder, based on another currency value
         *
         * @param currencyValue The currency value to use for currency and unit value
         *
         * @return this builder.
         */
        public CurrencyValueBuilder currencyValue(final CurrencyValue currencyValue) {
            return this
                    .currency(currencyValue.getCurrency())
                    .unitValue(currencyValue.getUnitValue());
        }

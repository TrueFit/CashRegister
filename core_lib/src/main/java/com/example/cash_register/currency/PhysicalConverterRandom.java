...
public final class PhysicalConverterRandom extends PhysicalConverterBase {
     ...
     */
    PhysicalConverterRandom(PhysicalSetMap physicalSetMap) {
    ...
    final static class PhysicalCurrencyDeque {
         ...
         * set to {@link null} when the elements of this deque change (only {@link #removeFirst()} modifies
         * this deque).
         *
         * @see #getRandom()
         * @see #removeFirst()
        ...
        /**
         * Creates a {@code PhysicalCurrencyDeque} and populates it with the provided {@link SortedSet<PhysicalCurrency>}.
         *
        ...
        /**
         * Implementation of {@link Deque#getFirst()}.
         *
         * @apiNote This method is treated as though {@link Deque} is being implemented, so it is intentionally
         * {@code public}.
         *
        ...
        /**
         * Implementation of {@link Deque#removeFirst()}.
         *
         * @apiNote This method is treated as though {@link Deque} is being implemented, so it is intentionally
         * {@code public} and, also, returns the removed item.
         *
        ...
        /**
         * Implementation of {@link Deque#isEmpty()}.
         *
         * @apiNote This method is treated as though {@link Deque} is being implemented, so it is intentionally
         * {@code public}.
         *

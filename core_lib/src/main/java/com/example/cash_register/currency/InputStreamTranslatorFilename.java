...
public class InputStreamTranslatorFilename extends InputStreamTranslatorBase<String> {
     ...
     */
    @Autowired
    private InputStreamTranslatorFilename(final InputStreamTranslatorPath inputStreamTranslatorPath) {
     ...
     */
    @Override
    protected InputStream translateImpl(final String filename) {

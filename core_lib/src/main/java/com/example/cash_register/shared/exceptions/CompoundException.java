...
public class CompoundException extends RuntimeException {
     ...
     */
    public CompoundException(final Collection<Throwable> throwableCollection) {
        this.exceptionList = new ExceptionList();
        this.getExceptionList().addAll(throwableCollection);
    }

    /**
     * The exception collection of this {@link CompoundException}.
     *
     * @return the exception collection of this {@link CompoundException}.
     */

...
public class ResourceUtils {
    ...
    public final List<String> readLinesFromResource(final String resourceName) {
        ResourceStringValidator resourceStringValidator = SpringContextUtils.getBean(ResourceStringValidator.class);
    ...
    public static final class ReadLinesFromResourceException extends RuntimeException {
        private ReadLinesFromResourceException(String message, Throwable cause) {
            super(message, cause);
        }
    }
}

...
public class FilesWrapper {
    ...
    public final Path createTempDir() {
        final int randomInt = ThreadLocalRandom.current().nextInt(5, 15);
        final String prefix = RandomStringUtils.randomAlphabetic(randomInt);
    ...
    public final Path createTempFile() {
        final int randomInt = ThreadLocalRandom.current().nextInt(5, 15);
        final String prefix = RandomStringUtils.randomAlphabetic(randomInt);
        final String suffix = RandomStringUtils.randomAlphabetic(randomInt);
     ...
     */
    public final Path createTempFile(final String prefix, final String suffix, final FileAttribute<?>... attrs) {
        try {
     ...
     * exception, that exception will be the cause.
     */
    public final Path createTempDir(final String prefix, final FileAttribute<?>... attrs) {
        try {
     ...
     */
    public final BufferedWriter newBufferedWriter(final Path path, final OpenOption... options) {
        try {
     ...
     */
    public final String readString(final Path path) {
        try {
    ...
    static final class CreateTempFileException extends RuntimeException {
        CreateTempFileException(final Throwable cause) {
    ...
    static final class NewBufferedWriterWrapperException extends RuntimeException {
        NewBufferedWriterWrapperException(final Throwable cause) {
    ...
    static final class CreateTempDirException extends RuntimeException {
        CreateTempDirException(final Throwable cause) {
    ...
    static final class ReadStringException extends RuntimeException {
        ReadStringException(final Throwable cause) {

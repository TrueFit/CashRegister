...
public class PropertiesUtils {
     ...
     * file.
     *
     * @param propertiesResourceName The properties resource name to parse; JVM System Properties overrides within
     * this properties resource will be removed.
     */
     ...
     */
    private Properties parsePropertiesFile(final String propertiesResourceName) {
    ...
    public static final class PropertiesLoadException extends RuntimeException {
        PropertiesLoadException(final Throwable cause) {

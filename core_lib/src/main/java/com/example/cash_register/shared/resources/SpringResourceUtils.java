...
public class SpringResourceUtils {
     ...
     *
     * @param filesWrapper Files wrapper
     * @param ioUtilsWrapper IOUtils wrapper
    ...
    public Path copyLocationPatternArrayToTempDir(final String... locationPatternArray) {
        ...
        try {
            for (String locationPattern : locationPatternArray) {
                Resource[] resourceArray = this.getSpringResources(locationPattern);
    ...
    public static final class CopyResourceToDirIOUtilsCopyException extends RuntimeException {
        private CopyResourceToDirIOUtilsCopyException(Throwable cause) {

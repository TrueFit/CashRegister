...
public class WriterWrapper {
     ...
     * cause.
     */
    public void write(final Writer thisWriter, final String str) {
        try {
     ...
     */
    public void writeLine(final Writer thisWriter, final String str) {
        try {
     ...
     * cause.
     */
    public void newLine(final Writer thisWriter) {
        try {
     ...
     */
    public void flush(final Writer thisWriter) {
        try {
            thisWriter.flush();
        }
        catch (final Throwable throwable) {
    ...
    public static final class WriteException extends RuntimeException {
        WriteException(final Throwable cause) {
    ...
    public static final class NewLineException extends RuntimeException {
        NewLineException(final Throwable cause) {
    ...
    public static final class WriteLineException extends RuntimeException {
        WriteLineException(final Throwable cause) {
    ...
    public static final class FlushException extends RuntimeException {
        FlushException(final Throwable cause) {

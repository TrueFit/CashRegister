...
public class TangoProperties {
     ...
     *
     * @see TangoPropertiesFile
     */
    private final TangoPropertiesFile tangoPropertiesFile;

    @Autowired
    TangoProperties(
            TangoPropertiesFile tangoPropertiesFile) {
    ...
    public BigInteger getRandomChangeDivisor() {
        BigInteger bigInteger = new BigInteger(this.tangoPropertiesFile.getRandomChangeDivisorValue());

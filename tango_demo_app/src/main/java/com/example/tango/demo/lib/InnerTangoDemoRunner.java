...
public class InnerTangoDemoRunner {
    ...
    /**
     * See {@link TangoInputFileProcessor}.
     */
    private final TangoInputFileProcessor tangoInputFileProcessor;

    /**
     * See {@link JsonInputFileProcessor}.
     */
    private final JsonInputFileProcessor jsonInputFileProcessor;

    /**
     * See {@link FileChooser}.
     */
     ...
     *
     * @param tangoInputFileProcessor See {@link TangoInputFileProcessor}.
     * @param jsonInputFileProcessor See {@link JsonInputFileProcessor}.
     * @param fileChooser See {@link FileChooser}.
     * @param springResourceUtils See {@link SpringResourceUtils}.
     */
    @Autowired
    private InnerTangoDemoRunner(
            final TangoInputFileProcessor tangoInputFileProcessor,
            final JsonInputFileProcessor jsonInputFileProcessor,
            final FileChooser fileChooser,
            final SpringResourceUtils springResourceUtils) {
        this.tangoInputFileProcessor = tangoInputFileProcessor;
        this.jsonInputFileProcessor = jsonInputFileProcessor;
     ...
     */
    public final void runImpl(final ApplicationArguments args) {
